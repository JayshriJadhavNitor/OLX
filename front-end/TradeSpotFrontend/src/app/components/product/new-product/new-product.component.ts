...
export class NewProductComponent {
    ...
    constructor(private fb: FormBuilder, private productService: ProductService) {
      {
        this.addProductForm = this.fb.group({
          ...
          addedDate: [new Date().toISOString().split('T')[0], Validators.required], // Initialize with today's date in YYYY-MM-DD format
    ...
    onSubmit(): void {
      ...
      this.productService.addProduct( categoryName,  userId,productDTO, this.selectedFile).subscribe(
        (response: any) => {
